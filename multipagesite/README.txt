...
Description: A standard page (clickable page) but not shown on the navbar.

Usage: unlistedPage(String Name, String URL [, String HTML, Function Do])
...
Methods:
	...
	More CSS:
		Description: CSS to be added to HEAD tag.
		Usage: (SITE)->moreCSS(String CSS)
...
The current version (v1.1) was created by Kyran Gostelow and released on 2018-08-25.
